...
public class Enter extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException{
		...
		sb.append(
				"<html><head><title>共演検索マシーン - 共同開発者募集</title><meta name=\"viewport\" content=\"user-scalable=no\" /><meta http-equiv=\"content-type\" content=\"text/html; charset=UTF-8\" />")
				.append("<meta name=\"description\" content=\"共演検索マシーンは共同開発者を募集しています。\">")
				.append("<meta name=\"keywords\" content=\"声優,共演,検索,アニメ,開発\">")
				...
				.append("<div id=\"guide\"><h2>共同開発者募集</h2>")
				.append("共演検索マシーンでは、共同開発者を募集しています。")
				.append("<br />ご興味のある方は、<a href=\"mailto:uotaneet@gmail.com>uotaneet@gmail.com</a>までコンタクトください。<ol><li>作品のタイトル</li><li>作品のカテゴリ</li><li>公開された年</li></ol>")
